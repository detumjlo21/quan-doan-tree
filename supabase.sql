...
-- Nếu bảng cũ đã tồn tại, bổ sung các cột mới.
...
create table if not exists public.quan_doan_branches (
  ...
  owner_name text not null default 'Chủ Nhánh', deputy_name text not null default 'Quyền Chủ',
  veteran1 text not null default 'Kỳ Cựu 1', veteran2 text not null default 'Kỳ Cựu 2', veteran3 text not null default 'Kỳ Cựu 3', created_at timestamptz not null default now()
);
...
select * from (values
 ('NHÁNH 1',1,'Chủ Nhánh 1','Quyền Chủ 1','Kỳ Cựu 1','Kỳ Cựu 2','Kỳ Cựu 3'),('NHÁNH 2',2,'Chủ Nhánh 2','Quyền Chủ 2','Kỳ Cựu 1','Kỳ Cựu 2','Kỳ Cựu 3'),('NHÁNH 3',3,'Chủ Nhánh 3','Quyền Chủ 3','Kỳ Cựu 1','Kỳ Cựu 2','Kỳ Cựu 3'),('NHÁNH 4',4,'Chủ Nhánh 4','Quyền Chủ 4','Kỳ Cựu 1','Kỳ Cựu 2','Kỳ Cựu 3'),('NHÁNH 5',5,'Chủ Nhánh 5','Quyền Chủ 5','Kỳ Cựu 1','Kỳ Cựu 2','Kỳ Cựu 3')
...
-- Tạo 6 Box mẫu nếu chưa có Box nào: Box Tổng + 5 nhánh.
insert into public.quan_doan_chat_boxes(title,subtitle,image_url,link_url,sort_order)
select * from (values
 ('Box Tổng ( 5 Nhánh )','', 'logo-quant-doan.jpg','#',1),
 ('PHOENIX 禄 ( Nhánh 1 )','', 'logo-quant-doan.jpg','#',2),
 ('PHOENIX 禄 ( Nhánh 2 )','', 'logo-quant-doan.jpg','#',3),
 ('PHOENIX 禄 ( Nhánh 3 )','', 'logo-quant-doan.jpg','#',4),
 ('PHOENIX 禄 ( Nhánh 4 )','', 'logo-quant-doan.jpg','#',5),
 ('PHOENIX 禄 ( Nhánh 5 )','', 'logo-quant-doan.jpg','#',6)
